...
=======
            ...
            <div class="studentDetails">
                <div class="studentNumberField">
                    <label for="studentNumber">Student Number</label>
                  <input type="text" id="studentNumber" name="studentNumber" placeholder="student number" value="<?php echo htmlspecialchars($user['student_number'] ?? ''); ?>">
                </div>

                <div class="studentNameField">
                    <label for="studentName">Name</label>
                    <input type="text" id="studentName" name="studentName" placeholder="name" value="<?php echo htmlspecialchars($user['name'] ?? ''); ?>">
                </div>

                <div class="studentProgramField">
                    <label for="studentProgram">Program</label>
                    <input type="text" id="studentProgram" name="studentProgram" placeholder="program" value="<?php echo htmlspecialchars($user['program'] ?? ''); ?>">
                </div>
            </div>
            ...
            <div class="sexGender">
                <div class="sexField">
                    ...
                    <input type="text" id="sex" name="sex" placeholder="sex" value="<?php echo htmlspecialchars($user['sex'] ?? ''); ?>">
                </div>
            ...
            <div class="contactDetails">
                <div class="mobileNumberField">
                    ...
                    <input type="text" id="mobileNumber" name="mobileNumber" placeholder="mobile number" value="<?php echo htmlspecialchars($user['mobile'] ?? ''); ?>">
                </div>

                <div class="landlineField">
                    <label for="landline">Landline</label>
                    <input type="text" id="landline" name="landline" placeholder="landline" value="<?php echo htmlspecialchars($user['landline'] ?? ''); ?>">
                </div>
            </div>
            ...
            <div class="emailAddress">
                <div class="emailAddressField">
                    ...
                    <input type="text" id="emailAd" name="emailAd" placeholder="email address" value="<?php echo htmlspecialchars($user['email'] ?? ''); ?>">
                </div>
            </div>
            ...
            <div class="mailingAddress">
                <div class="lotBlkField">
                    ...
                    <input type="text" id="lotBlk" name="lotBlk" placeholder="lot/blk no." value="<?php echo htmlspecialchars($user['lot_blk'] ?? ''); ?>">
                </div>

                <div class="streetField">
                    <label for="street">Street</label>
                    <input type="text" id="street" name="street" placeholder="street" value="<?php echo htmlspecialchars($user['street'] ?? ''); ?>">
                </div>

                <div class="zipCodeField">
                    <label for="zipCode">Zip Code</label>
                    <input type="text" id="zipcode" name="zipcode" placeholder="1230" value="<?php echo htmlspecialchars($user['zip_code'] ?? ''); ?>">
            ...
            <div class="mailingAddress">
                <div class="cityMunicipalityField">
                    ...
                    <input type="text" id="cityMunicipality" name="cityMunicipality" placeholder="city/municipality" value="<?php echo htmlspecialchars($user['city_municipality'] ?? ''); ?>">
                </div>

                <div class="countryField">
                    <label for="country">Country</label>
                    <input type="text" id="country" name="country" placeholder="country" value="<?php echo htmlspecialchars($user['country'] ?? ''); ?>">
                </div>
            </div>
